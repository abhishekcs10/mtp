...
What does a CPU core consistes of ?
=====================================

Reference `Core definition <https://stackoverflow.com/questions/19225859/difference-between-core-and-processor>`_
...
Below is a Diagram to show how on a socket of a processor multiple core can be placed.

.. figure:: images/ibm_multicore.png
   :alt: Multicore Architecture for a Processor

   **Diagram depicting Multicore Architecture of Processor**


A single core has following architecture-

.. figure:: images/single_core.jpg
   :alt: Single Core Architecture for a Processor

   **Diagram depicting Architecture of core of a Processor**
